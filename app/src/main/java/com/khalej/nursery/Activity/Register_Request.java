...
import com.khalej.nursery.Adapter.RecyclerAdapter_register_request;
import com.khalej.nursery.Adapter.RecyclerAdapter_sahb;
...
public class Register_Request extends AppCompatActivity {
    ...
    private RecyclerAdapter_register_request recyclerAdapter_secondry;
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_userinfo>> call = apiinterface.get_all_users_nursary();
            ...
            public void onResponse(Call<List<contact_userinfo>> call, Response<List<contact_userinfo>> response) {
                ...
                try {
                    if (contactList.size() > 0) {
                        recyclerAdapter_secondry = new RecyclerAdapter_register_request(Register_Request.this, contactList);
