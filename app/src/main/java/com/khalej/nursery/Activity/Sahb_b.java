...
public class Sahb_b extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_sahb_b recyclerAdapter_secondry;
            ...
            public void onResponse(Call<List<contact_userinfo>> call, Response<List<contact_userinfo>> response) {
                ...
                try {
                    if (contactList.size() > 0) {
                        recyclerAdapter_secondry = new RecyclerAdapter_sahb_b(Sahb_b.this, contactList);
