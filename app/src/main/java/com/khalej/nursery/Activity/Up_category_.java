...
public class Up_category_ extends AppCompatActivity {
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_category_);
...
spin=findViewById(R.id.spinCountry);
        ...
        dateSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(Up_category_.this,
        ...
        timeSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Up_category_.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        textInputEditTextaddress.setText(i.getStringExtra("details"));
    ...
    public void fetchInfo(){
        ...
        progressDialog = ProgressDialog.show(Up_category_.this,"Loading updae offer","Please wait...",false,false);
        progressDialog.show();
        apiinterface= Apiclient_home.getapiClient().create(apiinterface_home.class);
        Call<ResponseBody> call = apiinterface.getcontacts_update_first_category(textInputEditTextname.getText().toString()
                ,image,textInputEditTextphone.getText().toString()+"",textInputEditTextaddress.getText().toString()
                ,textInputEditTexterror.getText().toString(), category_id ,i.getIntExtra("id",0),dateSelect.getText().toString(),
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(Up_category_.this);
                dlgAlert.setMessage("Offer Updated Successfuly");
    ...
    public void fetchInfo_noImage(){
        ...
        progressDialog.show();
        apiinterface= Apiclient_home.getapiClient().create(apiinterface_home.class);
        Call<ResponseBody> call = apiinterface.getcontacts_update_first_category_noImage(textInputEditTextname.getText().toString()
                ,textInputEditTextphone.getText().toString()+"",textInputEditTextaddress.getText().toString()
                ,textInputEditTexterror.getText().toString(), category_id ,i.getIntExtra("id",0),
                dateSelect.getText().toString(),timeSelect.getText().toString());
