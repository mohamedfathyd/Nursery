...
public class Delete_general_category extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_deletegeneral recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_general_category);
            ...
            public void onResponse(Call<List<contact_home>> call, Response<List<contact_home>> response) {
                try {
                    ...
                    if(contactList.isEmpty()){
                        ...
                        recyclerAdapter_secondry = new RecyclerAdapter_deletegeneral(Delete_general_category.this, contactList);
