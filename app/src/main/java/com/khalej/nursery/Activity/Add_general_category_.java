...
public class Add_general_category_ extends AppCompatActivity {
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_general_category_);
        ...
        dateSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(Add_general_category_.this,
        ...
        timeSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Add_general_category_.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    public void fetchInfo(){
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(Add_general_category_.this,t.toString(),Toast.LENGTH_LONG).show();
            }
        });
    }
