...
import com.khalej.nursery.Adapter.RecyclerAdapter_updateannonce;
...
public class Update_annonce extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_updateannonce recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u_annonce);
            ...
            public void onResponse(Call<List<contact_annonce>> call, Response<List<contact_annonce>> response) {
                try {
                    ...
                    if (contactList.isEmpty()) {
                        ...
                        recyclerAdapter_secondry = new RecyclerAdapter_updateannonce(Update_annonce.this, contactList);
