...
import com.khalej.tarshed.Adapter.RecyclerAdapter_recervations;
import com.khalej.tarshed.Adapter.RecyclerAdapter_sahb;
...
public class Sahb extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_sahb recyclerAdapter_secondry;
            ...
            public void onResponse(Call<List<contact_userinfo>> call, Response<List<contact_userinfo>> response) {
                ...
                try {
                    if (contactList.size() > 0) {
                        recyclerAdapter_secondry = new RecyclerAdapter_sahb(Sahb.this, contactList);
