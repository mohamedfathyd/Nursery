...
import com.khalej.nursery.Activity.Up_general_category_;
...
public class RecyclerAdapter_updategeneral extends RecyclerView.Adapter<RecyclerAdapter_updategeneral.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_home> contactslist;
     apiinterface_home apiinterface;
    public RecyclerAdapter_updategeneral(Context context, List<contact_home> contactslist){
    ...
    holder.Name.setText(contactslist.get(position).getname());
       ...
       holder.itemView.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               Intent intent=new Intent(context, Up_general_category_.class);
