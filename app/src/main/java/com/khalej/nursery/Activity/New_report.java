...
AppCompatButton appCompatButtonRegister;
    ...
    public void fetchdata() {
        progressDialog = ProgressDialog.show(New_report.this, "جاري تسجيل التقرير", "Please wait...", false, false);
        progressDialog.show();
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                AlertDialog.Builder dlgAlert = new AlertDialog.Builder(New_report.this);
